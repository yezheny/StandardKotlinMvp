...
import static com.laj.standardkotlinmvp.widget.stateview.InjectorKt.changeChildrenConstraints;
...
public class StateView extends View {
    ...
    public StateView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mEmptyResource == 0) {
            mEmptyResource = R.layout.base_empty_view;
        }
        if (mRetryResource == 0) {
            mRetryResource = R.layout.base_retry_view;
        }
        if (mLoadingResource == 0) {
            mLoadingResource = R.layout.base_loading_view;
        }
    ...
    public int getActionBarHeight() {
        ...
        return height+ Resources.getSystem().getDimensionPixelSize(resourceId);
    }
